 ...
 * contestará con una v (verdadero) o una f (falso). Cada pregunta contestada
 * con v sumará 3 puntos. Las preguntas contestadas con f no suman puntos. 
...
public class C4ejercicio16 { 
  ...
  public static void main(String[] args) {
    ...
    System.out.println("\nTEST DE FIDELIDAD\n");
    System.out.println("Este programa averiguará si tu pareja es infiel.\n");
