/*
 * 4. Crea la clase Fracción. Los atributos serán numerador y denominador. Y algunos de los métodos pueden ser invierte,
 *    simplifica, multiplica, divide, etc.
 */
package C9ejercicio04;
...
public class Fraccion {
  ...
  public Fraccion(int n, int d) {
    ...
    if (d == 0) {
      System.out.println("Esto no es una fracción");
